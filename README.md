...
*Fork by CR24 adding some additions from the newest version*

This driver is for the Adafruit TCS34725 Breakout.  
--> http://www.adafruit.com/products/1334

## About this Driver ##
This is a fork of the original TCS34725 driver.
You can read about it here: https://github.com/adafruit/Adafruit_TCS34725

## How to use ##
1. Install SoftwareWire library with some modifications by [Fire7](https://github.com/Fire7/) with empty constructor  
